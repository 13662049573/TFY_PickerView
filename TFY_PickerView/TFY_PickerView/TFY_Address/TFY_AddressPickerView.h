...
typedef void(^ _Nullable TFY_AddressResultBlock)(TFY_AddressModel * _Nonnull province, CityModel * _Nonnull city, AreaModel * _Nonnull area);
typedef void(^ _Nullable TFY_AddressCancelBlock)(void);

...
typedef void(^TFYCancelBlock)(void);
typedef void(^TFYDoneClickBlock)(void);
...
@property (nullable, nonatomic, strong) TFY_PickerStyle *pickerStyle;

/** 取消选择的回调 */
@property (nullable, nonatomic, copy) TFYCancelBlock cancelBlock;
...
@property (nullable, nonatomic, copy) TFYDoneClickBlock doneBlock;
